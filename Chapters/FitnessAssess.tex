...
There are some methods to estimate HR max by interval running.\todo{add some}

\subsection*{Age-based methods to calculate HR max}
As the running methods are generally too complex to do "on the spot", there have been attempts to calculate HR max based on readily available data.
