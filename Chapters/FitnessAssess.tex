...
The formula they developed for men:
 ...
 \textit{where weight is body weight (kg), 6MWD is distance walked in 6 min (m), age (years), BMI is calculated body mass index (kg/m2), height is body height (cm) and HR is heart rate at the end of the walking test (bpm).}
...
Another study from 2015 instead used resting heart rate and arrived at this formula:

$VO2 max =70.161 + 0.023 \times 6MWT - 0.276 \times weight - 6.79 \times sex - 0.193 \times resting\+_HR - 0.191 \times age$

using 6MWT -- distance walked (m), weight (kg), sex - 1 for female, 0 for male, and resting heart rate in bears per minute.

\subsubsection*{Sit-to-Stand test}

\todo[color=green]{Potentially valid test with arm support: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4657412/}
...
todo[color=green]{these should not be used in medicine because they are self-reported}
